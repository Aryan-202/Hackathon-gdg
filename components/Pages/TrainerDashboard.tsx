          ...
          <div className="flex-1 p-8">
            <div className="max-w-7xl mx-auto">
              <h1 className="text-4xl font-bold mb-8">
                <span className="text-purple-600 dark:text-purple-400">AI Trainer</span>
              </h1>

              <div className="backdrop-blur-2xl bg-gray-300/5 rounded-3xl p-8 shadow-lg border border-border">
                <h2 className="text-2xl font-semibold mb-6 text-white">Performance Analytics</h2>

                {loading ? (
                  <div className="flex flex-col items-center justify-center py-20">
                    <div className="animate-spin rounded-full h-10 w-10 border-b-2 border-purple-600 mb-4"></div>
                    <p className="text-gray-400">Analyzing your scores...</p>
                  </div>
                ) : (
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <StatsTab title="Interview Readiness" value="78%" footer="Based on last 3 sessions" />
                    <StatsTab title="Mock Test Average" value="82/100" footer="Top 15% of users" />
                    <StatsTab title="Technical Accuracy" value="High" footer="Focus on System Design" />
                  </div>
                )}
              </div>
            </div>
